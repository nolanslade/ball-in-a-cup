...
void drawRectPrism(float objectVertices[8][3], float objectFaces[6][4], bool insidePrism) {
	...
	for (int i = 0; i < 6; i++) {
		...
		// Drawing an outside-facing rectangular prism (i.e. table); therefore we reverse vertex order
		} else {
			switch (i) {          
				case 0:
					norm_inds[3][0] =  0; 	norm_inds[3][1] =  3;	norm_inds[3][2] =  4;
					norm_inds[2][0] =  2; 	norm_inds[2][1] =  0;	norm_inds[2][2] =  4;
					norm_inds[1][0] =  5; 	norm_inds[1][1] =  0;	norm_inds[1][2] =  2;	
					norm_inds[0][0] =  5; 	norm_inds[0][1] =  0;	norm_inds[0][2] =  3;	
					break;

				case 1:
					norm_inds[3][0] =  2; 	norm_inds[3][1] =  4;	norm_inds[3][2] =  1;
					norm_inds[2][0] =  3; 	norm_inds[2][1] =  4;	norm_inds[2][2] =  1;
					norm_inds[1][0] =  5; 	norm_inds[1][1] =  3;	norm_inds[1][2] =  1;
					norm_inds[0][0] =  5; 	norm_inds[0][1] =  2;	norm_inds[0][2] =  1;
					break;

				case 2:
					norm_inds[3][0] =  0; 	norm_inds[3][1] =  4;	norm_inds[3][2] =  2;
					norm_inds[2][0] =  2; 	norm_inds[2][1] =  4;	norm_inds[2][2] =  1;
					norm_inds[1][0] =  5; 	norm_inds[1][1] =  2;	norm_inds[1][2] =  1;
					norm_inds[0][0] =  0; 	norm_inds[0][1] =  5;	norm_inds[0][2] =  2;
					break;

				case 3:
					norm_inds[3][0] =  3; 	norm_inds[3][1] =  4;	norm_inds[3][2] =  1;
					norm_inds[2][0] =  3; 	norm_inds[2][1] =  4;	norm_inds[2][2] =  0;
					norm_inds[1][0] =  3; 	norm_inds[1][1] =  5;	norm_inds[1][2] =  0;
					norm_inds[0][0] =  3; 	norm_inds[0][1] =  5;	norm_inds[0][2] =  1;
					break;

				case 4:
					norm_inds[3][0] =  2; 	norm_inds[3][1] =  4;	norm_inds[3][2] =  1;
					norm_inds[2][0] =  0; 	norm_inds[2][1] =  4;	norm_inds[2][2] =  2;
					norm_inds[1][0] =  3; 	norm_inds[1][1] =  4;	norm_inds[1][2] =  0;
					norm_inds[0][0] =  3; 	norm_inds[0][1] =  4;	norm_inds[0][2] =  1;
					break;

				case 5:
					norm_inds[3][0] =  0; 	norm_inds[3][1] =  5;	norm_inds[3][2] =  2;
					norm_inds[2][0] =  5; 	norm_inds[2][1] =  2;	norm_inds[2][2] =  1;	
					norm_inds[1][0] =  3; 	norm_inds[1][1] =  5;	norm_inds[1][2] =  1;
					norm_inds[0][0] =  3; 	norm_inds[0][1] =  5;	norm_inds[0][2] =  0;
					break;
			}
		}
...
void display() {
	...
	//--------------------END DRAWING GUI TEXT------------------------------------------
        ...
        // Draw the ball
        if (!switchingPlayer&&!playerOneShooting&&!playerTwoShooting) {
